...
import com.thomaskioko.podadddict.musicplayerlib.media.MediaSessionWrapper;

import java.io.IOException;


/**
 * Service used as PodAdddictPlayer.
 *
 * @author kioko
 */
public class PlaybackService extends Service implements MediaPlayer.OnErrorListener,
     ...
     * package private, used by the NotificationManager for PendingIntent.
     */
    static final String ACTION_CLEAR_NOTIFICATION = "player_clear";
     ...
     */
    static final String ACTION_AUDIO_BECOMING_NOISY = "player_becoming_noisy";
    ...
    /**
     * Action used to resume the pod adddict player.
     */
    private static final String ACTION_PAUSE_PLAYER = "player_resume";

    /**
     * Action used to pause the pod adddict player.
     */
    private static final String ACTION_RESUME_PLAYER = "player_pause";

    /**
     * Action used to stop the pod adddict player.
     */
    private static final String ACTION_STOP_PLAYER = "player_stop";
    ...
    /**
     * Pod adddict notification manager.
     */
     ...
     * as well as {@link com.thomaskioko.podadddict.musicplayerlib.remote.RemoteControlClientCompat}
     */
    ...
    public static void play(Context context, Track track) {
        ...
        intent.putExtra(BUNDLE_KEY_TRACK, track);
    ...
    private void playTrack(Track track) {
        ...
        try {
            ...
            // UPDATE ALL VISUAL CALLBACK FIRST TO IMPROVE USER EXPERIENCE
            updateNotification();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case WHAT_PREVIOUS_TRACK:
                    ...
                    break;
                case WHAT_SEEK_TO:
                    seekToPosition(data.getInt(BUNDLE_KEY_TRACK_POSITION));
                    break;
