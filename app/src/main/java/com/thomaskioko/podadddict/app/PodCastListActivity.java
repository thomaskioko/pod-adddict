...
import com.thomaskioko.podadddict.app.dummy.DummyContent;
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(PodCastDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(PodCastDetailFragment.ARG_ITEM_ID, holder.mItem.id);
