...
public class TracksAdapter extends RecyclerView.Adapter<TracksAdapter.Holder>
    implements PodAdddictPlayerListener, SwipeToDismissGesture.Dismisser {
     ...
     * @param tracks   tracks.
     */
    public TracksAdapter(TrackView.Listener listener, List<Track> tracks) {
        super();
        mTracks = tracks;
            ...
            case VIEW_TYPE_TRACK:
                ...
                if (i == mPlayedTrackPosition) {
                    ((TrackHolder) holder).trackView
                        .setBackgroundResource(R.drawable.selectable_background_blue_light);
    ...
    public interface Listener {
         ...
         *
         * @param position adapter position of the item which should be removed
         */
        void onTrackDismissed(int position);
    }
}
