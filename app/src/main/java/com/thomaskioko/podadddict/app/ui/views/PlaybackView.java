...
public class PlaybackView extends FrameLayout implements View.OnClickListener,
        PodAdddictPlayerListener, SeekBar.OnSeekBarChangeListener {
    ...
    private void setTrack(Track track) {
        if (track == null) {
            ...
            Glide.with(mTrackArtwork.getContext())
                    .load(track.getArtworkUrl())
                    .crossFade()
    ...
    private void init(Context context) {
        ...
        mTrackArtwork = ((ImageView) findViewById(R.id.track_view_artwork));
