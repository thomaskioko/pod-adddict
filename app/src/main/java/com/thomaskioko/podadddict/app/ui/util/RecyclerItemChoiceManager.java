...
/**
 * The RecyclerItemChoiceManager class keeps track of which positions have been selected.
 *
 * @author Thomas Kioko
 */
public class RecyclerItemChoiceManager {
    private final String LOG_TAG = RecyclerItemChoiceManager.class.getSimpleName();
     ...
     */
    public RecyclerItemChoiceManager(RecyclerView.Adapter adapter) {
        mAdapter = adapter;
    }
    ...
    public void onClick(RecyclerView.ViewHolder viewHolder) {
        ...
        switch (mChoiceMode) {
            ...
            case AbsListView.CHOICE_MODE_MULTIPLE_MODAL: {
                throw new RuntimeException("Multiple Modal not implemented in RecyclerItemChoiceManager.");
            }
        }
    }
    ...
    /**
     * @param viewHolder Recycler ViewHolder
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (viewHolder.itemView instanceof Checkable) {
            ((Checkable) viewHolder.itemView).setChecked(checked);
        }
        ViewCompat.setActivated(viewHolder.itemView, checked);
    }

    /**
     * Helper method to restore data saved.
     *
    ...
    /**
     * Helper method to get the selected position in the recyclerView
     *
